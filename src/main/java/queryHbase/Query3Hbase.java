...
public class Query3Hbase {
            ...
            for ( AvgRating k : Chart2.getAvgRating()) {
                int j = 0;
            		...
            		if(app !=null){
        				...
        				hbc.put("tableQuery3", k.getTitle(), "fi","avg", k.getAvg().toString(), "fi", "diff-pos",app.toString());

            		}else{
                    	//Se non posso confrontare non dichiaro.
            			//salvo in Hbase il risultato
        				hbc.put("tableQuery3", k.getTitle(), "fi","avg", k.getAvg().toString(), "fi", "diff-pos","ND");
            		}
            		i++;
            }
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(Query3Hbase.class);
        
        hbc = new HBaseClient();
        //creazione tabella Hbase
        if (!hbc.exists("tableQuery3")){
            System.out.println("Creating table...");
            hbc.createTable("tableQuery3", "fi");
        }
        ...
        System.out.println(hbc.describeTable("tableQuery3"));
