...
public class Query2Hbase {
    ...
    public static class StatsReducer extends Reducer<Text, Text, Text, Text> {
        ...
        public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
        	...
        	hbc.put("tableQuery2",key.toString(), "fi","avg", returnGt.getAvg().toString(), "fi", "dev",returnGt.getDev().toString() );
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        job1.setJarByClass(Query2Hbase.class);
       
        hbc = new HBaseClient();
        //creazione tabella Hbase
        if (!hbc.exists("tableQuery2")){
            System.out.println("Creating table...");
            hbc.createTable("tableQuery2", "fi");
        }
        ...
        if (code == 0) {
            ...
            job2.setJarByClass(Query2Hbase.class);
            ...
            System.out.println(hbc.describeTable("tableQuery2"));
